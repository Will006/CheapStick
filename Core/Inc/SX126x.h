...
#define FREQ_DIV                        ( double )0x2000000
#define FREQ_STEP                       0.95367
...
#define SX126X_SLEEP_START_COLD                       0x00 //  2     2     sleep mode: cold start, configuration is lost (default)
#define SX126X_SLEEP_START_WARM                       0x04 //  2     2                 warm start, configuration is retained
#define SX126X_SLEEP_RTC_OFF                          0x00 //  0     0     wake on RTC timeout: disabled
#define SX126X_SLEEP_RTC_ON                           0x01 //  0     0                          enabled
...
#define SX126X_CALIBRATE_IMAGE_OFF                    0x00 //  6     6     image calibration: disabled
#define SX126X_CALIBRATE_IMAGE_ON                     0x40 //  6     6                        enabled
#define SX126X_CALIBRATE_ADC_BULK_P_OFF               0x00 //  5     5     ADC bulk P calibration: disabled
#define SX126X_CALIBRATE_ADC_BULK_P_ON                0x20 //  5     5                             enabled
#define SX126X_CALIBRATE_ADC_BULK_N_OFF               0x00 //  4     4     ADC bulk N calibration: disabled
#define SX126X_CALIBRATE_ADC_BULK_N_ON                0x10 //  4     4                             enabled
#define SX126X_CALIBRATE_ADC_PULSE_OFF                0x00 //  3     3     ADC pulse calibration: disabled
#define SX126X_CALIBRATE_ADC_PULSE_ON                 0x08 //  3     3                            enabled
#define SX126X_CALIBRATE_PLL_OFF                      0x00 //  2     2     PLL calibration: disabled
#define SX126X_CALIBRATE_PLL_ON                       0x04 //  2     2                      enabled
#define SX126X_CALIBRATE_RC13M_OFF                    0x00 //  1     1     13 MHz RC osc. calibration: disabled
#define SX126X_CALIBRATE_RC13M_ON                     0x02 //  1     1                                 enabled
#define SX126X_CALIBRATE_RC64K_OFF                    0x00 //  0     0     64 kHz RC osc. calibration: disabled
#define SX126X_CALIBRATE_RC64K_ON                     0x01 //  0     0                                 enabled
...
#define SX126X_IRQ_TIMEOUT                          0x200 //  9     9     Rx or Tx timeout
#define SX126X_IRQ_CAD_DETECTED                     0x100 //  8     8     channel activity detected
#define SX126X_IRQ_CAD_DONE                         0x80 //  7     7     channel activity detection finished
#define SX126X_IRQ_CRC_ERR                          0x40 //  6     6     wrong CRC received
#define SX126X_IRQ_HEADER_ERR                       0x20 //  5     5     LoRa header CRC error
#define SX126X_IRQ_HEADER_VALID                     0x10 //  4     4     valid LoRa header received
#define SX126X_IRQ_SYNC_WORD_VALID                  0x08 //  3     3     valid sync word detected
#define SX126X_IRQ_PREAMBLE_DETECTED                0x04 //  2     2     preamble detected
#define SX126X_IRQ_RX_DONE                          0x02 //  1     1     packet received
#define SX126X_IRQ_TX_DONE                          0x01 //  0     0     packet transmission completed
#define SX126X_IRQ_ALL                              0x3ff //  9     0     all interrupts
#define SX126X_IRQ_NONE                             0x00 //  9     0     no interrupts
...
#define SX126X_STATUS_MODE_STDBY_RC                   0x20 //  6     4     current chip mode: STDBY_RC
#define SX126X_STATUS_MODE_STDBY_XOSC                 0x30 //  6     4                        STDBY_XOSC
#define SX126X_STATUS_MODE_FS                         0x40 //  6     4                        FS
#define SX126X_STATUS_MODE_RX                         0x50 //  6     4                        RX
#define SX126X_STATUS_MODE_TX                         0x60 //  6     4                        TX
#define SX126X_STATUS_DATA_AVAILABLE                  0x04 //  3     1     command status: packet received and data can be retrieved
#define SX126X_STATUS_CMD_TIMEOUT                     0x06 //  3     1                     SPI command timed out
#define SX126X_STATUS_CMD_INVALID                     0x08 //  3     1                     invalid SPI command
#define SX126X_STATUS_CMD_FAILED                      0x0a //  3     1                     SPI command failed to execute
#define SX126X_STATUS_TX_DONE                         0x0c //  3     1                     packet transmission done

//SX126X_CMD_GET_PACKET_STATUS
#define SX126X_GFSK_RX_STATUS_PREAMBLE_ERR            0x80 //  7     7     GFSK Rx status: preamble error
#define SX126X_GFSK_RX_STATUS_SYNC_ERR                0x40 //  6     6                     sync word error
#define SX126X_GFSK_RX_STATUS_ADRS_ERR                0x20 //  5     5                     address error
#define SX126X_GFSK_RX_STATUS_CRC_ERR                 0x10 //  4     4                     CRC error
#define SX126X_GFSK_RX_STATUS_LENGTH_ERR              0x08 //  3     3                     length error
#define SX126X_GFSK_RX_STATUS_ABORT_ERR               0x04 //  2     2                     abort error
#define SX126X_GFSK_RX_STATUS_PACKET_RECEIVED         0x02 //  2     2                     packet received
#define SX126X_GFSK_RX_STATUS_PACKET_SENT             0x01 //  2     2                     packet sent

//SX126X_CMD_GET_DEVICE_ERRORS
#define SX126X_PA_RAMP_ERR                           0x100 //  8     8     device errors: PA ramping failed
#define SX126X_PLL_LOCK_ERR                          0x40 //  6     6                    PLL failed to lock
#define SX126X_XOSC_START_ERR                        0x20 //  5     5                    crystal oscillator failed to start
#define SX126X_IMG_CALIB_ERR                         0x10 //  4     4                    image calibration failed
#define SX126X_ADC_CALIB_ERR                         0x08 //  3     3                    ADC calibration failed
#define SX126X_PLL_CALIB_ERR                         0x04 //  2     2                    PLL calibration failed
#define SX126X_RC13M_CALIB_ERR                       0x02 //  1     1                    RC13M calibration failed
#define SX126X_RC64K_CALIB_ERR                       0x01 //  0     0                    RC64K calibration failed
...
GPIO_PIN_TypeDef     SX126x_SPI_SELECT;
GPIO_PIN_TypeDef     SX126x_RESET;
GPIO_PIN_TypeDef     SX126x_BUSY;
GPIO_PIN_TypeDef     SX126x_INT0;
}SX126x;
